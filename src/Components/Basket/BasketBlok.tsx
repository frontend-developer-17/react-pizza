...
import {deleteBasket } from '../../Redux/Slise/BasketSlise';
import { Link } from 'react-router-dom';
import { RootState } from '../../Redux/store';
import Reduse from '../../utils/Reduse';

export default function Basket() {
  const items = useSelector((state:RootState) => state.basketSlise.items);
  const prise = useSelector((state:RootState) => state.basketSlise.totalPrise);
        ...
        <div>
          <div className="cart">
            <div className="cart__top">
              ...
              <div onClick={() => dispatch(deleteBasket())} className="cart__clear">
                <svg
                  width="20"
                  height="20"
                  viewBox="0 0 20 20"
